                                ...
                                <div class="ec-sidebar-block">
                                    ...
                                    <div class="ec-sb-block-content">
                                        ...
                                        <div class="ec-sidebar-block">
                                            ...
                                            <div class="ec-sb-block-content es-price-slider bg-transparent ">
                                                <form method="GET" action="{{ url('products') }}">
                                                    <div class="ec-price-filter">
                                                        <div class="ec-price-input">
                                                            <label class=""> Rp.<input type="text"
                                                                    name="price" class="filter__input"></label>
                                                            <span class="ec-price-divider"></span>
                                                            <label class="">Rp.<input type="text" name="price"
                                                        ...
                                                        <button class="mt-1 rounded-5  btn btn-primary btn-block"
