                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.attributes.attribute_options.create', $attribute) }}"
                                class="btn btn-success shadow-sm float-right"> <i class="fa fa-plus"></i> Tambah</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <fieldset class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group row border-bottom pb-4">
                                                <label for="is_required" class="col-sm-2 col-form-label">Harus Di isi
                                                    ?</label>
                                                <div class="col-sm-10">
                                ...
                                <fieldset class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group row border-bottom pb-4">
                                                <label for="is_configurable" class="col-sm-2 col-form-label">Konfigurasi
                                                    Produk ?</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row border-bottom pb-4">
                                                <label for="is_filterable" class="col-sm-2 col-form-label">Filter Produk
                                                    ?</label>
                                                <div class="col-sm-10">
