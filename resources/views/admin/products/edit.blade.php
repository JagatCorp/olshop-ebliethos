    ...
    <section class="ec-content-wrapper">
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <div>
                    <a href="{{ route('admin.products.index') }}" class="btn btn-primary shadow-sm float-right">
                        <i class="fa fa-arrow-left"></i> Kembali</a>
                    <a href="{{ route('admin.products.product_images.index', $product) }}"
                        class="btn btn-primary shadow-sm mr-2 float-right"> <i class="fa fa-image"></i> Upload
                        Gambar Produk</a>
                </div>
            </div>
            <div class="row">
