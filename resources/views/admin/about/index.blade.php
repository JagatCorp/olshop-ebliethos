            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <p class="breadcrumbs"><span><a href="index.html">Home</a></span>
                        <span><i class="mdi mdi-chevron-right"></i></span>About
                    </p>
                </div>
                <div>
                    ...
                    <div class="modal-content">
                        <form action="{{ route('admin.create-about') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-header px-4">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah About</h5>
                            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('admin.delete-about', $item->id) }}" class="btn btn-danger"
