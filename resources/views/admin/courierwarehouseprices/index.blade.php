                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-4">
                                                <label for="userName">Name Courierwarehouseprices</label>
                                                <input type="text" class="form-control"
                                                    name="courierwarehouseprices_name" required />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-4">
                                                <label for="userName">Name Courierwarehouseprices</label>
                                                <input type="text" class="form-control"
                                                    name="courierwarehouseprices_name"
                                                    value="{{ $item->courierwarehouseprices_name }}" />
                                            </div>
                                        </div>
